...
- A 31,248-row municipality-month hotel-demand panel and a separate 31,248-row official HESTA capacity panel, current point-municipality crosswalk, official Magic Pass evidence table, and resort-level data-quality table are reproducibly generated.
...
The run ends with the automated test suite. Main checkpoint reports are `reports/01_DATA_AUDIT.md`, `reports/02_DATA_COLLECTION.md`, `reports/03_DATA_QUALITY.md`, `reports/04_DESTINATION_UNIT_REVIEW.md`, `reports/05_HOTEL_CAPACITY.md`, and `reports/model_feasibility_report.md`.
